//Using 2D perlin noise to determine color, speed and direction of particles. Press 'r' to spawn 5000 new particles at random location, hit the space bar to clear the screen.
